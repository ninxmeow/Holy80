...
/**
 * @file        AIR32F10x/cmparams.h
 * @brief       ARM Cortex-M3 parameters for the Westberry AIR32F10x
 *
 * @defgroup    ARMCMx_AIR32F10x Westberry AIR32F10x Specific Parameters
 * @ingroup     ARMCMx_SPECIFIC
 * @details     This file contains the Cortex-M3 specific parameters for the
 *              Westberry AIR32F10x platform.
 * @{
 */
