...
#define __NVIC_PRIO_BITS          3 /*!< air32 uses 4 Bits for the Priority Levels    */
...
typedef struct
{
  ...
  __IO uint16_t DP_PUUP;         /*!< DP pull up register,                    Address offset: 0x54 */
...
#define USB_PMAADDR                          (0x40006000U)               /*!< USB_IP Packet Memory Area base address */
...
#define USB_DP_PUUP                          (USB_BASE + 0x54)           /*!< DP pull up register */
