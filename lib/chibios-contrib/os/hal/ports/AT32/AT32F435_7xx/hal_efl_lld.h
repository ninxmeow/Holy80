...
/**
 * @file    AT32F435_7xx/hal_efl_lld.h
 * @brief   AT32F435_7xx Embedded Flash subsystem low level driver header.
 *
 * @addtogroup HAL_EFL
 * @{
 */
...
/**
 * @name    AT32F435_7xx configuration options
 * @{
 */
/**
...
#define AT32_FLASH_WAIT_TIME_MS            50
#endif
/** @} */
