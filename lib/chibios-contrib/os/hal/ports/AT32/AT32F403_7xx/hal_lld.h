...
#define AT32_PLLHEXTDIV_NODIV       (0 << 17)   /**< HEXT no divided.           */
#define AT32_PLLHEXTDIV_DIV         (1 << 17)   /**< HEXT divided .             */
...
#define AT32_HEXTDIV_DIV2           (0 << 12)
#define AT32_HEXTDIV_DIV3           (1 << 12)
#define AT32_HEXTDIV_DIV4           (2 << 12)
#define AT32_HEXTDIV_DIV5           (3 << 12)
/** @} */
 ...
 */
#if !defined(AT32F403_7xx_MCUCONF)
#error "Using a wrong mcuconf.h file, AT32F403_7xx_MCUCONF not defined"
#endif
