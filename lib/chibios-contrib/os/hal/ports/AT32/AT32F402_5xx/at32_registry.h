...
/**
 * @file    AT32F402_5xx/at32_registry.h
 * @brief   AT32F402_5xx capabilities registry.
 *
 * @addtogroup HAL
 * @{
 */
...
#error "unsupported or unrecognized AT32F402_5xx member"
#endif
...
/**
 * @name    AT32F402_5Rx capabilities
 * @{
 */
/* ADC attributes.*/
#define AT32_HAS_ADC1                       TRUE
