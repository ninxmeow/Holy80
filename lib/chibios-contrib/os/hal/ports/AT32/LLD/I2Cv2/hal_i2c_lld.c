...
static void i2c_lld_serve_interrupt(I2CDriver *i2cp, uint32_t sts) {
  ...
  if ((sts & I2C_STS_ACKFAILF) != 0U) {
    ...
    dp->CTRL1 &= ~(I2C_CTRL2_TDCIEN | I2C_CTRL1_TDIEN | I2C_CTRL1_RDIEN);
...
msg_t i2c_lld_master_receive_timeout(I2CDriver *i2cp, i2caddr_t addr,
  ...
  dp->CTRL1 |= I2C_CTRL2_TDCIEN | I2C_CTRL1_RDIEN;
#endif
...
msg_t i2c_lld_master_transmit_timeout(I2CDriver *i2cp, i2caddr_t addr,
  ...
  dp->CTRL1 |= I2C_CTRL2_TDCIEN | I2C_CTRL1_TDIEN;
#endif
