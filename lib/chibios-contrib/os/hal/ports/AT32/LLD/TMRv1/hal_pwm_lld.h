 ...
 * @note    The default is @p FALSE.
 */
#if !defined(AT32_PWM_USE_TMR15) || defined(__DOXYGEN__)
#define AT32_PWM_USE_TMR15                 FALSE
#endif
 ...
 * @note    The default is @p FALSE.
 */
#if !defined(AT32_PWM_USE_TMR16) || defined(__DOXYGEN__)
#define AT32_PWM_USE_TMR16                 FALSE
#endif
 ...
 * @note    The default is @p FALSE.
 */
#if !defined(AT32_PWM_USE_TMR17) || defined(__DOXYGEN__)
#define AT32_PWM_USE_TMR17                 FALSE
#endif
 ...
 * @note    The default is @p FALSE.
 */
#if !defined(AT32_PWM_USE_TMR21) || defined(__DOXYGEN__)
#define AT32_PWM_USE_TMR21                 FALSE
#endif
 ...
 * @note    The default is @p FALSE.
 */
#if !defined(AT32_PWM_USE_TMR22) || defined(__DOXYGEN__)
#define AT32_PWM_USE_TMR22                 FALSE
#endif
 ...
 */
#if !defined(AT32_PWM_TMR15_IRQ_PRIORITY) || defined(__DOXYGEN__)
#define AT32_PWM_TMR15_IRQ_PRIORITY        7
#endif

/**
 * @brief   PWMD16 interrupt priority level setting.
 */
#if !defined(AT32_PWM_TMR16_IRQ_PRIORITY) || defined(__DOXYGEN__)
#define AT32_PWM_TMR16_IRQ_PRIORITY        7
#endif

/**
 * @brief   PWMD17 interrupt priority level setting.
 */
#if !defined(AT32_PWM_TMR17_IRQ_PRIORITY) || defined(__DOXYGEN__)
#define AT32_PWM_TMR17_IRQ_PRIORITY        7
#endif
 ...
 */
#if !defined(AT32_PWM_TMR21_IRQ_PRIORITY) || defined(__DOXYGEN__)
#define AT32_PWM_TMR21_IRQ_PRIORITY        7
#endif

/**
 * @brief   PWMD22 interrupt priority level setting.
 */
#if !defined(AT32_PWM_TMR22_IRQ_PRIORITY) || defined(__DOXYGEN__)
#define AT32_PWM_TMR22_IRQ_PRIORITY        7
#endif
/** @} */
...
#if AT32_PWM_USE_TMR15 && !AT32_HAS_TMR15
#error "TMR15 not present in the selected device"
#endif

#if AT32_PWM_USE_TMR16 && !AT32_HAS_TMR16
#error "TMR16 not present in the selected device"
#endif

#if AT32_PWM_USE_TMR17 && !AT32_HAS_TMR17
...
#if AT32_PWM_USE_TMR21 && !AT32_HAS_TMR21
#error "TMR21 not present in the selected device"
#endif

#if AT32_PWM_USE_TMR22 && !AT32_HAS_TMR22
#error "TMR22 not present in the selected device"
    ...
    !AT32_PWM_USE_TMR15 && !AT32_PWM_USE_TMR16 &&                         \
    !AT32_PWM_USE_TMR17 && !AT32_PWM_USE_TMR20 &&                         \
    !AT32_PWM_USE_TMR21 && !AT32_PWM_USE_TMR22
...
#error "PWMD15 requires TMR15 but the timer is already used"
#else
...
#error "PWMD16 requires TMR16 but the timer is already used"
#else
...
#error "PWMD17 requires TMR17 but the timer is already used"
#else
...
#error "PWMD21 requires TMR21 but the timer is already used"
#else
...
#error "PWMD22 requires TMR22 but the timer is already used"
#else
...
#if AT32_PWM_USE_TMR15 && !defined(AT32_TMR15_SUPPRESS_ISR) &&            \
    !OSAL_IRQ_IS_VALID_PRIORITY(AT32_PWM_TMR15_IRQ_PRIORITY)
#error "Invalid IRQ priority assigned to TMR15"
#endif

#if AT32_PWM_USE_TMR16 && !defined(AT32_TMR16_SUPPRESS_ISR) &&            \
    !OSAL_IRQ_IS_VALID_PRIORITY(AT32_PWM_TMR16_IRQ_PRIORITY)
#error "Invalid IRQ priority assigned to TMR16"
#endif

#if AT32_PWM_USE_TMR17 && !defined(AT32_TMR17_SUPPRESS_ISR) &&            \
    !OSAL_IRQ_IS_VALID_PRIORITY(AT32_PWM_TMR17_IRQ_PRIORITY)
...
#if AT32_PWM_USE_TMR21 && !defined(AT32_TMR21_SUPPRESS_ISR) &&            \
    !OSAL_IRQ_IS_VALID_PRIORITY(AT32_PWM_TMR21_IRQ_PRIORITY)
#error "Invalid IRQ priority assigned to TMR21"
#endif

#if AT32_PWM_USE_TMR22 && !defined(AT32_TMR22_SUPPRESS_ISR) &&            \
    !OSAL_IRQ_IS_VALID_PRIORITY(AT32_PWM_TMR22_IRQ_PRIORITY)
...
#if AT32_PWM_USE_TMR15 && !defined(__DOXYGEN__)
extern PWMDriver PWMD15;
#endif

#if AT32_PWM_USE_TMR16 && !defined(__DOXYGEN__)
extern PWMDriver PWMD16;
#endif

#if AT32_PWM_USE_TMR17 && !defined(__DOXYGEN__)
...
#if AT32_PWM_USE_TMR21 && !defined(__DOXYGEN__)
extern PWMDriver PWMD21;
#endif

#if AT32_PWM_USE_TMR22 && !defined(__DOXYGEN__)
