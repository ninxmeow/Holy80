...
#define AT32_TMR_CTRL2_TRGOUT2EN           (1U << 31)
/** @} */
...
#define AT32_TMR_STCTRL_SMSEL(n)           (((n) & 7) << 0)
...
#define AT32_TMR_ISTS_TRIGIF               (1U << 6)
#define AT32_TMR_ISTS_BRKIF                (1U << 7)
#define AT32_TMR_ISTS_BRK2IF               (1U << 8)
...
#define AT32_TMR_SWEVT_BRK2SWTR            (1U << 8)
/** @} */
...
#define AT32_TMR_CM1_C1OCTRL(n)            (((n) & 7) << 4)
...
#define AT32_TMR_CM1_C2OCTRL(n)            (((n) & 7) << 12)

#define AT32_TMR_CM1_C2OSEN                (1U << 15)
/** @} */

/**
 * @name    CM1 register (input)
 * @{
 */
...
#define AT32_TMR_CM2_C3OCTRL(n)            (((n) & 7) << 4)
...
#define AT32_TMR_CM2_C4OCTRL(n)            (((n) & 7) << 12)
...
#define AT32_TMR_CCTRL_C4CEN               (1U << 14)
#define AT32_TMR_CCTRL_C4CP                (1U << 15)
/** @} */
...
#define AT32_TMR_BRK_BK2F_MASK            (15U << 20)
#define AT32_TMR_BRK_BK2F(n)              ((n) << 20)

#define AT32_TMR_BRK_BK2E                 (1U << 24)
#define AT32_TMR_BRK_BK2P                 (1U << 25)
/** @} */
...
/**
 * @name    TMR_CM3 register
 * @{
 */
#define AT32_TMR_CM3_C5OIEN               (1U << 2)
#define AT32_TMR_CM3_C5OBEN               (1U << 3)

#define AT32_TMR_CM3_C5OCTRL_MASK         (7U << 4)
#define AT32_TMR_CM3_C5OCTRL(n)           (((n) & 7) << 4)

#define AT32_TMR_CM3_C5OSEN               (1U << 7)

#define AT32_TMR_CM3_C6OIEN               (1U << 10)
#define AT32_TMR_CM3_C6OBEN               (1U << 11)

#define AT32_TMR_CM3_C6OCTRL_MASK         (7U << 12)
#define AT32_TMR_CM3_C6OCTRL(n)           (((n) & 7) << 12)

#define AT32_TMR_CM3_C6OSEN               (1U << 15)
/** @} */
...
#define AT32_TMR15     ((at32_tmr_t *)TMR15_BASE)
#define AT32_TMR16     ((at32_tmr_t *)TMR16_BASE)
#define AT32_TMR17     ((at32_tmr_t *)TMR17_BASE)
#define AT32_TMR18     ((at32_tmr_t *)TMR18_BASE)
#define AT32_TMR19     ((at32_tmr_t *)TMR19_BASE)
#define AT32_TMR20     ((at32_tmr_t *)TMR20_BASE)
#define AT32_TMR21     ((at32_tmr_t *)TMR21_BASE)
#define AT32_TMR22     ((at32_tmr_t *)TMR22_BASE)
/** @} */
