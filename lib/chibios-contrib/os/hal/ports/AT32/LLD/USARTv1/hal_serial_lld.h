 ...
 * @note    The default is @p FALSE.
 */
#if !defined(AT32_SERIAL_USE_UART9) || defined(__DOXYGEN__)
#define AT32_SERIAL_USE_UART9              FALSE
#endif
 ...
 * @note    The default is @p FALSE.
 */
#if !defined(AT32_SERIAL_USE_UART10) || defined(__DOXYGEN__)
#define AT32_SERIAL_USE_UART10             FALSE
#endif
 ...
 */
#if !defined(AT32_SERIAL_UART9_PRIORITY) || defined(__DOXYGEN__)
#define AT32_SERIAL_UART9_PRIORITY         12
#endif

/**
 * @brief   UART10 interrupt priority level setting.
 */
#if !defined(AT32_SERIAL_UART10_PRIORITY) || defined(__DOXYGEN__)
#define AT32_SERIAL_UART10_PRIORITY        12
#endif
/** @} */
...
#if AT32_SERIAL_USE_UART9 && !AT32_HAS_UART9
#error "UART9 not present in the selected device"
#endif

#if AT32_SERIAL_USE_UART10 && !AT32_HAS_UART10
#error "UART10 not present in the selected device"
    ...
    !AT32_SERIAL_USE_UART9  && !AT32_SERIAL_USE_UART10
...
#error "Invalid IRQ priority assigned to UART8"
    ...
    !OSAL_IRQ_IS_VALID_PRIORITY(AT32_SERIAL_UART9_PRIORITY)
#error "Invalid IRQ priority assigned to UART9"
#endif

#if AT32_SERIAL_USE_UART10 &&                                               \
    !OSAL_IRQ_IS_VALID_PRIORITY(AT32_SERIAL_UART10_PRIORITY)
