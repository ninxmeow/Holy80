 ...
 * @note    The default is @p FALSE.
 */
#if !defined(AT32_UART_USE_UART9) || defined(__DOXYGEN__)
#define AT32_UART_USE_UART9                FALSE
#endif
 ...
 * @note    The default is @p FALSE.
 */
#if !defined(AT32_UART_USE_UART10) || defined(__DOXYGEN__)
#define AT32_UART_USE_UART10               FALSE
#endif
 ...
 */
#if !defined(AT32_UART_UART9_IRQ_PRIORITY) || defined(__DOXYGEN__)
#define AT32_UART_UART9_IRQ_PRIORITY       12
#endif

/**
 * @brief   UART10 interrupt priority level setting.
 */
#if !defined(AT32_UART_UART10_IRQ_PRIORITY) || defined(__DOXYGEN__)
#define AT32_UART_UART10_IRQ_PRIORITY      12
#endif
 ...
 *          over the TX channel.
 */
#if !defined(AT32_UART_UART9_DMA_PRIORITY) || defined(__DOXYGEN__)
#define AT32_UART_UART9_DMA_PRIORITY       0
#endif
 ...
 *          over the TX channel.
 */
#if !defined(AT32_UART_UART10_DMA_PRIORITY) || defined(__DOXYGEN__)
#define AT32_UART_UART10_DMA_PRIORITY      0
#endif
...
#define AT32_UART_USART6_RX_DMAMUX_CHANNEL    1
#define AT32_UART_USART6_TX_DMAMUX_CHANNEL    2
#endif
...
#define AT32_UART_UART7_RX_DMAMUX_CHANNEL    1
#define AT32_UART_UART7_TX_DMAMUX_CHANNEL    2
#endif
...
#define AT32_UART_UART8_RX_DMAMUX_CHANNEL    1
#define AT32_UART_UART8_TX_DMAMUX_CHANNEL    2
#endif
...
#define AT32_UART_UART9_RX_DMAMUX_CHANNEL    1
#define AT32_UART_UART9_TX_DMAMUX_CHANNEL    2
#endif
...
#if AT32_UART_USE_UART9 && !AT32_HAS_UART9
#error "UART9 not present in the selected device"
#endif

#if AT32_UART_USE_UART10 && !AT32_HAS_UART10
#error "UART10 not present in the selected device"
    ...
    !AT32_UART_USE_UART9  && !AT32_UART_USE_UART10
...
#error "Invalid IRQ priority assigned to UART8"
    ...
    !OSAL_IRQ_IS_VALID_PRIORITY(AT32_UART_UART9_IRQ_PRIORITY)
#error "Invalid IRQ priority assigned to UART9"
#endif

#if AT32_UART_USE_UART10 &&                                                \
    !OSAL_IRQ_IS_VALID_PRIORITY(AT32_UART_UART10_IRQ_PRIORITY)
...
#if AT32_UART_USE_UART9 &&                                                 \
    !AT32_DMA_IS_VALID_PRIORITY(AT32_UART_UART9_DMA_PRIORITY)
#error "Invalid DMA priority assigned to UART9"
#endif

#if AT32_UART_USE_UART10 &&                                                \
    !AT32_DMA_IS_VALID_PRIORITY(AT32_UART_UART10_DMA_PRIORITY)
...
#if AT32_UART_USE_UART9
#if defined(AT32_UART9_IS_USED)
#error "UARTD9 requires UART9 but it is already used"
#else
#define AT32_UART9_IS_USED
#endif
#endif

#if AT32_UART_USE_UART10
#if defined(AT32_UART10_IS_USED)
#error "UARTD10 requires UART10 but it is already used"
#else
#define AT32_UART10_IS_USED
#endif
#endif
