...
/**
 * @file    AT32F423xx/at32_registry.h
 * @brief   AT32F423xx capabilities registry.
 *
 * @addtogroup HAL
 * @{
 */
...
#error "unsupported or unrecognized AT32F423xx member"
#endif
...
#if defined(AT32F423Kx) || defined(AT32F423Tx) || defined(__DOXYGEN__)
/**
 * @name    AT32F423Kx AT32F423Tx capabilities
 * @{
 */
/* ADC attributes.*/
#define AT32_ADC_MAX_CHANNELS               28
...
/* EXINT attributes.*/
#define AT32_EXINT_NUM_LINES                29
#define AT32_EXINT_INTEN_MASK               0x00000000U

/* Flash attributes.*/
#define AT32_FLASH_NUMBER_OF_BANKS          1
#if defined(AT32F423x8) || defined(AT32F423xB)
#define AT32_FLASH_SECTOR_SIZE              1024U
#elif defined(AT32F423xC)
#define AT32_FLASH_SECTOR_SIZE              2048U
#endif
#if !defined(AT32_FLASH_SECTORS_PER_BANK) || defined(__DOXYGEN__)
#if defined(AT32F423x8)
#define AT32_FLASH_SECTORS_PER_BANK         64 
#elif defined(AT32F423xB) || defined(AT32F423xC)
#define AT32_FLASH_SECTORS_PER_BANK         128
#endif
#endif
...
#endif /* defined(AT32F423Kx) */

#if defined(AT32F423Cx)
/**
 * @name    AT32F423Cx capabilities
 * @{
 */
/* ADC attributes.*/
#define AT32_ADC_MAX_CHANNELS               28
...
#endif /* defined(AT32F423Cx) */

#if defined(AT32F423Rx)
/**
 * @name    AT32F423Vx capabilities
 * @{
 */
/* ADC attributes.*/
#define AT32_ADC_MAX_CHANNELS               28
...
#endif /* defined(AT32F423Rx) */

#if defined(AT32F423Vx)
/**
 * @name    AT32F423Vx capabilities
 * @{
 */
