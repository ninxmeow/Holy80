 ...
 * @brief   AIR32 GPT subsystem low level driver source.
 *
 * @addtogroup GPT
 * @{
 */
...
#endif /* AIR32_GPT_USE_TIM5 */

#if AIR32_GPT_USE_TIM6 || defined(__DOXYGEN__)
#if !defined(AIR32_TIM6_SUPPRESS_ISR)
#if !defined(AIR32_TIM6_HANDLER)
#error "AIR32_TIM6_HANDLER not defined"
#endif
/**
 ...
 * @isr
 */
OSAL_IRQ_HANDLER(AIR32_TIM6_HANDLER) {
...
#endif /* !defined(AIR32_TIM6_SUPPRESS_ISR) */
#endif /* AIR32_GPT_USE_TIM6 */

#if AIR32_GPT_USE_TIM7 || defined(__DOXYGEN__)
#if !defined(AIR32_TIM7_SUPPRESS_ISR)
#if !defined(AIR32_TIM7_HANDLER)
#error "AIR32_TIM7_HANDLER not defined"
#endif
/**
 ...
 * @isr
 */
OSAL_IRQ_HANDLER(AIR32_TIM7_HANDLER) {
...
#endif /* !defined(AIR32_TIM7_SUPPRESS_ISR) */
#endif /* AIR32_GPT_USE_TIM7 */
...
void gpt_lld_start(GPTDriver *gptp) {
  ...
  if (gptp->state == GPT_STOP) {
    ...
    if (&GPTD1 == gptp) {
      ...
      rccResetTIM1();
#if !defined(AIR32_TIM1_SUPPRESS_ISR)
      nvicEnableVector(AIR32_TIM1_UP_NUMBER, AIR32_GPT_TIM1_IRQ_PRIORITY);
#endif
#if defined(AIR32_TIM1CLK)
      gptp->clock = AIR32_TIM1CLK;
#else
      gptp->clock = AIR32_TIMCLK2;
#endif
    }
#endif
    ...
    if (&GPTD2 == gptp) {
      ...
      rccResetTIM2();
#if !defined(AIR32_TIM2_SUPPRESS_ISR)
      nvicEnableVector(AIR32_TIM2_NUMBER, AIR32_GPT_TIM2_IRQ_PRIORITY);
#endif
#if defined(AIR32_TIM2CLK)
      gptp->clock = AIR32_TIM2CLK;
#else
      gptp->clock = AIR32_TIMCLK1;
#endif
    }
#endif
    ...
    if (&GPTD3 == gptp) {
      ...
      rccResetTIM3();
#if !defined(AIR32_TIM3_SUPPRESS_ISR)
      nvicEnableVector(AIR32_TIM3_NUMBER, AIR32_GPT_TIM3_IRQ_PRIORITY);
#endif
#if defined(AIR32_TIM3CLK)
      gptp->clock = AIR32_TIM3CLK;
#else
      gptp->clock = AIR32_TIMCLK1;
#endif
    }
    ...
    if (&GPTD4 == gptp) {
      ...
      rccResetTIM4();
#if !defined(AIR32_TIM4_SUPPRESS_ISR)
      nvicEnableVector(AIR32_TIM4_NUMBER, AIR32_GPT_TIM4_IRQ_PRIORITY);
#endif
#if defined(AIR32_TIM4CLK)
      gptp->clock = AIR32_TIM4CLK;
#else
      gptp->clock = AIR32_TIMCLK1;
#endif
    }
    ...
    if (&GPTD5 == gptp) {
      ...
      rccResetTIM5();
#if !defined(AIR32_TIM5_SUPPRESS_ISR)
      nvicEnableVector(AIR32_TIM5_NUMBER, AIR32_GPT_TIM5_IRQ_PRIORITY);
#endif
#if defined(AIR32_TIM5CLK)
      gptp->clock = AIR32_TIM5CLK;
#else
      gptp->clock = AIR32_TIMCLK1;
#endif
    }
    ...
    if (&GPTD6 == gptp) {
      ...
      rccResetTIM6();
#if !defined(AIR32_TIM6_SUPPRESS_ISR)
      nvicEnableVector(AIR32_TIM6_NUMBER, AIR32_GPT_TIM6_IRQ_PRIORITY);
#endif
#if defined(AIR32_TIM6CLK)
      gptp->clock = AIR32_TIM6CLK;
#else
      gptp->clock = AIR32_TIMCLK1;
#endif
    }
    ...
    if (&GPTD7 == gptp) {
      ...
      rccResetTIM7();
#if !defined(AIR32_TIM7_SUPPRESS_ISR)
      nvicEnableVector(AIR32_TIM7_NUMBER, AIR32_GPT_TIM7_IRQ_PRIORITY);
#endif
#if defined(AIR32_TIM7CLK)
      gptp->clock = AIR32_TIM7CLK;
#else
      gptp->clock = AIR32_TIMCLK1;
#endif
    }
    ...
    if (&GPTD8 == gptp) {
      ...
      rccResetTIM8();
#if !defined(AIR32_TIM8_SUPPRESS_ISR)
      nvicEnableVector(AIR32_TIM8_UP_NUMBER, AIR32_GPT_TIM8_IRQ_PRIORITY);
#endif
#if defined(AIR32_TIM8CLK)
      gptp->clock = AIR32_TIM8CLK;
#else
      gptp->clock = AIR32_TIMCLK2;
#endif
    }
    ...
    if (&GPTD9 == gptp) {
      ...
      rccResetTIM9();
#if !defined(AIR32_TIM9_SUPPRESS_ISR)
      nvicEnableVector(AIR32_TIM9_NUMBER, AIR32_GPT_TIM9_IRQ_PRIORITY);
#endif
#if defined(AIR32_TIM9CLK)
      gptp->clock = AIR32_TIM9CLK;
#else
      gptp->clock = AIR32_TIMCLK2;
#endif
    }
    ...
    if (&GPTD10 == gptp) {
      ...
      rccResetTIM10();
#if !defined(AIR32_TIM10_SUPPRESS_ISR)
      nvicEnableVector(AIR32_TIM10_NUMBER, AIR32_GPT_TIM10_IRQ_PRIORITY);
#endif
#if defined(AIR32_TIM10CLK)
      gptp->clock = AIR32_TIM10CLK;
#else
      gptp->clock = AIR32_TIMCLK2;
#endif
    }
    ...
    if (&GPTD11 == gptp) {
      ...
      rccResetTIM11();
#if !defined(AIR32_TIM11_SUPPRESS_ISR)
      nvicEnableVector(AIR32_TIM11_NUMBER, AIR32_GPT_TIM11_IRQ_PRIORITY);
#endif
#if defined(AIR32_TIM11CLK)
      gptp->clock = AIR32_TIM11CLK;
#else
      gptp->clock = AIR32_TIMCLK2;
#endif
    }
    ...
    if (&GPTD12 == gptp) {
      ...
      rccResetTIM12();
#if !defined(AIR32_TIM12_SUPPRESS_ISR)
      nvicEnableVector(AIR32_TIM12_NUMBER, AIR32_GPT_TIM12_IRQ_PRIORITY);
#endif
#if defined(AIR32_TIM12CLK)
      gptp->clock = AIR32_TIM12CLK;
#else
      gptp->clock = AIR32_TIMCLK1;
#endif
    }
    ...
    if (&GPTD13 == gptp) {
      ...
      rccResetTIM13();
#if !defined(AIR32_TIM13_SUPPRESS_ISR)
      nvicEnableVector(AIR32_TIM13_NUMBER, AIR32_GPT_TIM13_IRQ_PRIORITY);
#endif
#if defined(AIR32_TIM13CLK)
      gptp->clock = AIR32_TIM13CLK;
#else
      gptp->clock = AIR32_TIMCLK1;
#endif
    }
    ...
    if (&GPTD14 == gptp) {
      ...
      rccResetTIM14();
#if !defined(AIR32_TIM14_SUPPRESS_ISR)
      nvicEnableVector(AIR32_TIM14_NUMBER, AIR32_GPT_TIM14_IRQ_PRIORITY);
#endif
#if defined(AIR32_TIM14CLK)
      gptp->clock = AIR32_TIM14CLK;
#else
      gptp->clock = AIR32_TIMCLK1;
#endif
    }
...
void gpt_lld_stop(GPTDriver *gptp) {
  ...
  if (gptp->state == GPT_READY) {
    ...
    if (&GPTD6 == gptp) {
#if !defined(AIR32_TIM6_SUPPRESS_ISR)
      nvicDisableVector(AIR32_TIM6_NUMBER);
#endif
      rccDisableTIM6();
    }
#endif
    ...
    if (&GPTD7 == gptp) {
#if !defined(AIR32_TIM7_SUPPRESS_ISR)
      nvicDisableVector(AIR32_TIM7_NUMBER);
#endif
      rccDisableTIM7();
    }
#endif
    ...
    if (&GPTD9 == gptp) {
#if !defined(AIR32_TIM9_SUPPRESS_ISR)
      nvicDisableVector(AIR32_TIM9_NUMBER);
#endif
      rccDisableTIM9();
    }
#endif
    ...
    if (&GPTD10 == gptp) {
#if !defined(AIR32_TIM10_SUPPRESS_ISR)
      nvicDisableVector(AIR32_TIM10_NUMBER);
#endif
      rccDisableTIM10();
    }
#endif
    ...
    if (&GPTD11 == gptp) {
#if !defined(AIR32_TIM11_SUPPRESS_ISR)
      nvicDisableVector(AIR32_TIM11_NUMBER);
#endif
      rccDisableTIM11();
    }
#endif
    ...
    if (&GPTD12 == gptp) {
#if !defined(AIR32_TIM12_SUPPRESS_ISR)
      nvicDisableVector(AIR32_TIM12_NUMBER);
#endif
      rccDisableTIM12();
    }
#endif
    ...
    if (&GPTD13 == gptp) {
#if !defined(AIR32_TIM13_SUPPRESS_ISR)
      nvicDisableVector(AIR32_TIM13_NUMBER);
#endif
      rccDisableTIM13();
    }
#endif
    ...
    if (&GPTD14 == gptp) {
#if !defined(AIR32_TIM14_SUPPRESS_ISR)
      nvicDisableVector(AIR32_TIM14_NUMBER);
#endif
      rccDisableTIM14();
    }
#endif
...
void gpt_lld_start_timer(GPTDriver *gptp, gptcnt_t interval) {
  ...
  if (NULL != gptp->config->callback)
    gptp->tim->DIER |= AIR32_TIM_DIER_UIE;      /* Update Event IRQ enabled.*/
  gptp->tim->CR1 = AIR32_TIM_CR1_ARPE | AIR32_TIM_CR1_URS | AIR32_TIM_CR1_CEN;
}
...
void gpt_lld_stop_timer(GPTDriver *gptp) {
  ...
  gptp->tim->DIER &= ~AIR32_TIM_DIER_IRQ_MASK;
}
...
void gpt_lld_serve_interrupt(GPTDriver *gptp) {
  ...
  sr  = gptp->tim->SR;
  sr &= gptp->tim->DIER & AIR32_TIM_DIER_IRQ_MASK;
  gptp->tim->SR = ~sr;
