...
#if (OSAL_ST_RESOLUTION == 32) && !AIR32_TIM3_IS_32BITS
#error "TIM3 is not a 32bits timer"
#endif

#define ST_HANDLER                          AIR32_TIM3_HANDLER
#define ST_NUMBER                           AIR32_TIM3_NUMBER
#define ST_CLOCK_SRC                        AIR32_TIMCLK1
...
#if (OSAL_ST_RESOLUTION == 32) && !AIR32_TIM4_IS_32BITS
#error "TIM4 is not a 32bits timer"
#endif

#define ST_HANDLER                          AIR32_TIM4_HANDLER
#define ST_NUMBER                           AIR32_TIM4_NUMBER
#define ST_CLOCK_SRC                        AIR32_TIMCLK1
...
#if (OSAL_ST_RESOLUTION == 32) && !AIR32_TIM5_IS_32BITS
#error "TIM5 is not a 32bits timer"
#endif

#define ST_HANDLER                          AIR32_TIM5_HANDLER
#define ST_NUMBER                           AIR32_TIM5_NUMBER
#define ST_CLOCK_SRC                        AIR32_TIMCLK1
...
#if (OSAL_ST_RESOLUTION == 32) && !AIR32_TIM9_IS_32BITS
#error "TIM9 is not a 32bits timer"
#endif

#define ST_HANDLER                          AIR32_TIM9_HANDLER
#define ST_NUMBER                           AIR32_TIM9_NUMBER
#define ST_CLOCK_SRC                        AIR32_TIMCLK2
...
#if (OSAL_ST_RESOLUTION == 32) && !AIR32_TIM10_IS_32BITS
#error "TIM10 is not a 32bits timer"
#endif

#define ST_HANDLER                          AIR32_TIM10_HANDLER
#define ST_NUMBER                           AIR32_TIM10_NUMBER
#define ST_CLOCK_SRC                        AIR32_TIMCLK2
...
#if (OSAL_ST_RESOLUTION == 32) && !AIR32_TIM11_IS_32BITS
#error "TIM11 is not a 32bits timer"
#endif

#define ST_HANDLER                          AIR32_TIM11_HANDLER
#define ST_NUMBER                           AIR32_TIM11_NUMBER
#define ST_CLOCK_SRC                        AIR32_TIMCLK2
...
#if (OSAL_ST_RESOLUTION == 32) && !AIR32_TIM12_IS_32BITS
#error "TIM12 is not a 32bits timer"
#endif

#define ST_HANDLER                          AIR32_TIM12_HANDLER
#define ST_NUMBER                           AIR32_TIM12_NUMBER
#define ST_CLOCK_SRC                        AIR32_TIMCLK1
...
#if (OSAL_ST_RESOLUTION == 32) && !AIR32_TIM13_IS_32BITS
#error "TIM13 is not a 32bits timer"
#endif

#define ST_HANDLER                          AIR32_TIM13_HANDLER
#define ST_NUMBER                           AIR32_TIM13_NUMBER
#define ST_CLOCK_SRC                        AIR32_TIMCLK1
...
#if (OSAL_ST_RESOLUTION == 32) && !AIR32_TIM14_IS_32BITS
#error "TIM14 is not a 32bits timer"
#endif

#define ST_HANDLER                          AIR32_TIM14_HANDLER
#define ST_NUMBER                           AIR32_TIM14_NUMBER
#define ST_CLOCK_SRC                        AIR32_TIMCLK1
...
#if (OSAL_ST_RESOLUTION == 32) && !AIR32_TIM21_IS_32BITS
#error "TIM21 is not a 32bits timer"
#endif

#define ST_HANDLER                          AIR32_TIM21_HANDLER
#define ST_NUMBER                           AIR32_TIM21_NUMBER
#define ST_CLOCK_SRC                        AIR32_TIMCLK2
...
#if (OSAL_ST_RESOLUTION == 32) && !AIR32_TIM22_IS_32BITS
#error "TIM21 is not a 32bits timer"
#endif

#define ST_HANDLER                          AIR32_TIM22_HANDLER
#define ST_NUMBER                           AIR32_TIM22_NUMBER
#define ST_CLOCK_SRC                        AIR32_TIMCLK2
...
#if defined(AIR32_CORE_CK)
#define SYSTICK_CK                          AIR32_CORE_CK
#else
#define SYSTICK_CK                          AIR32_HCLK
#endif
...
#if !defined(AIR32_SYSTICK_SUPPRESS_ISR)
/**
...
void st_lld_init(void) {
  ...
  AIR32_ST_TIM->PSC    = (ST_CLOCK_SRC / OSAL_ST_FREQUENCY) - 1;
  AIR32_ST_TIM->ARR    = ST_ARR_INIT;
  AIR32_ST_TIM->CCMR1  = 0;
  AIR32_ST_TIM->CCR[0] = 0;
#if ST_LLD_NUM_ALARMS > 1
  AIR32_ST_TIM->CCR[1] = 0;
#endif
#if ST_LLD_NUM_ALARMS > 2
  AIR32_ST_TIM->CCR[2] = 0;
#endif
#if ST_LLD_NUM_ALARMS > 3
  AIR32_ST_TIM->CCR[3] = 0;
#endif
  AIR32_ST_TIM->DIER   = 0;
  AIR32_ST_TIM->CR2    = 0;
  AIR32_ST_TIM->EGR    = TIM_EGR_UG;
  AIR32_ST_TIM->CR1    = TIM_CR1_CEN;

#if !defined(AIR32_SYSTICK_SUPPRESS_ISR)
  /* IRQ enabled.*/
  nvicEnableVector(ST_NUMBER, AIR32_ST_IRQ_PRIORITY);
#endif
#endif /* OSAL_ST_MODE == OSAL_ST_MODE_FREERUNNING */
  ...
  /* IRQ enabled.*/
  nvicSetSystemHandlerPriority(HANDLER_SYSTICK, AIR32_ST_IRQ_PRIORITY);
#endif /* OSAL_ST_MODE == OSAL_ST_MODE_PERIODIC */
}
...
#if OSAL_ST_MODE == OSAL_ST_MODE_FREERUNNING
  uint32_t sr;
  air32_tim_t *timp = AIR32_ST_TIM;

  sr  = timp->SR;
  sr &= timp->DIER & AIR32_TIM_DIER_IRQ_MASK;
  timp->SR = ~sr;
