 ...
 * @brief   AIR32 PAL low level driver header.
 *
 * @addtogroup PAL
 * @{
 */
...
/**
 * @name    AIR32-specific I/O mode flags
 * @{
 */
/**
 * @brief   AIR32 specific alternate push-pull output mode.
 */
#define PAL_MODE_AIR32_ALTERNATE_PUSHPULL   16

/**
 * @brief   AIR32 specific alternate open-drain output mode.
 */
#define PAL_MODE_AIR32_ALTERNATE_OPENDRAIN  17

/**
 * @brief   AIR32 specific pullup-down output mode.
 */
#define PUPD_ENABLE_KEY				((uint32_t)0xa5a5a5a5)

/**
 * @brief   AIR32 specific pullup-down output mode.
 */
#define PUPD_DISABLE_KEY			((uint32_t)0xFFFFFFFF)
/** @} */
...
typedef struct {
  ...
  uint32_t      crh;
  // /** Initial value for PUPDEN register.*/
  // uint32_t      pupden;
  // /** Initial value for PUPDLOCK register.*/
  // uint32_t      pupdlock;
} air32_gpio_setup_t;

/**
 * @brief   AIR32 GPIO static initializer.
...
typedef struct {
  ...
  air32_gpio_setup_t    PAData;
  /** @brief Port B setup data.*/
  air32_gpio_setup_t    PBData;
  /** @brief Port C setup data.*/
  air32_gpio_setup_t    PCData;
  /** @brief Port D setup data.*/
  air32_gpio_setup_t    PDData;
} PALConfig;
...
/* The low level driver wraps the definitions already present in the AIR32   */
/* firmware library.                                                         */
/*===========================================================================*/
 ...
 */
#if AIR32_HAS_GPIOA || defined(__DOXYGEN__)
 ...
 */
#if AIR32_HAS_GPIOB || defined(__DOXYGEN__)
 ...
 */
#if AIR32_HAS_GPIOC || defined(__DOXYGEN__)
 ...
 */
#if AIR32_HAS_GPIOD || defined(__DOXYGEN__)
