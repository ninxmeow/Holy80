...
/**
 * @file    AIR32F10x/hal_adc_lld.h
 * @brief   AIR32F10x ADC subsystem low level driver header.
 *
 * @addtogroup ADC
 * @{
 */
 ...
 */
#if !defined(AIR32_ADC_USE_ADC1) || defined(__DOXYGEN__)
 ...
 */
#if !defined(AIR32_ADC_ADC1_DMA_PRIORITY) || defined(__DOXYGEN__)
 ...
 */
#if !defined(AIR32_ADC_ADC1_IRQ_PRIORITY) || defined(__DOXYGEN__)
#define AIR32_ADC_ADC1_IRQ_PRIORITY         5
#endif
/** @} */
...
#if AIR32_ADC_USE_ADC1 && !AIR32_HAS_ADC1
