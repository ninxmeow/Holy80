...
#ifndef RAW_HID_POLLING_INTERVAL_MS
#if defined(QMK_USB_SUPPORT_HS)
#    define RAW_HID_POLLING_INTERVAL_MS 4
#else
#    define RAW_HID_POLLING_INTERVAL_MS 1
#endif
#endif

#ifndef HID_RGB_POLLING_INTERVAL_MS
#    define HID_RGB_POLLING_INTERVAL_MS 1
#endif
...
USB_Descriptor_Configuration_t PROGMEM ConfigurationDescriptor = {
    ...
    .Raw_INEndpoint = {
        ...
        .PollingIntervalMS      = RAW_HID_POLLING_INTERVAL_MS
    },
    .Raw_OUTEndpoint = {
        .Header = {
            .Size               = sizeof(USB_Descriptor_Endpoint_t),
    ...
    .HIDRGB_INEndpoint = {
        ...
        .PollingIntervalMS      = HID_RGB_POLLING_INTERVAL_MS
    },
    .HIDRGB_OUTEndpoint = {
        .Header = {
            .Size               = sizeof(USB_Descriptor_Endpoint_t),
...
#if defined(QMK_USB_SUPPORT_HS)
/*
 * Device qualified descriptors
 */
const USB_Descriptor_DeviceQualifier_t PROGMEM DeviceQualifiedDescriptor = {
    .Header = {
...
uint16_t get_usb_descriptor(const uint16_t wValue, const uint16_t wIndex, const uint16_t wLength, const void** const DescriptorAddress) {
...
#ifndef KEYBOARD_SHARED_EP
    ConfigurationDescriptor.Keyboard_INEndpoint.PollingIntervalMS = pollingInterva;
#endif

#if defined(MOUSE_ENABLE) && !defined(MOUSE_SHARED_EP)
    ConfigurationDescriptor.Mouse_INEndpoint.PollingIntervalMS = pollingInterva;   
#endif

#ifdef SHARED_EP_ENABLE
    ConfigurationDescriptor.Shared_INEndpoint.PollingIntervalMS = pollingInterva;
#endif

#if defined(JOYSTICK_ENABLE) && !defined(JOYSTICK_SHARED_EP)
    ConfigurationDescriptor.Joystick_INEndpoint.PollingIntervalMS = pollingInterva;
#endif

#if defined(DIGITIZER_ENABLE) && !defined(DIGITIZER_SHARED_EP)
    ConfigurationDescriptor.Digitizer_INEndpoint.PollingIntervalMS = pollingInterva;
#endif

#ifdef HIDRGB_PROTOCOL_ENABLE
    ConfigurationDescriptor.HIDRGB_OUTEndpoint.PollingIntervalMS = pollingInterva;
#endif
    ...
    switch (DescriptorType) {
        ...
        case DTYPE_DeviceQualifier:
            Address = &DeviceQualifiedDescriptor;
            Size    = sizeof(USB_Descriptor_DeviceQualifier_t);
