...
typedef enum {UART_CONFIRM_FALSE = 0, UART_CONFIRM_TRUE = !UART_CONFIRM_FALSE} uart_confirm_state;
...
#define USART1_LIB                           ((usart_type *) USART1_BASE)
#define USART2_LIB                           ((usart_type *) USART2_BASE)
#define USART3_LIB                           ((usart_type *) USART3_BASE)
#define USART4_LIB                           ((usart_type *) USART4_BASE)
#define USART5_LIB                           ((usart_type *) USART5_BASE)
#define USART6_LIB                           ((usart_type *) USART6_BASE)
#define UART7_LIB                            ((usart_type *) UART7_BASE)
#define UART8_LIB                            ((usart_type *) UART8_BASE)
