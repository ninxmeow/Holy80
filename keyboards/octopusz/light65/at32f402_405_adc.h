...
typedef enum {ADC_CONFIRM_FALSE = 0, ADC_CONFIRM_TRUE = !ADC_CONFIRM_FALSE} adc_confirm_state;
...
typedef struct
{
  adc_confirm_state                          sequence_mode;           /*!< adc sequence mode */
  adc_confirm_state                          repeat_mode;             /*!< adc repeat mode */
...
#define ADC1_LIB                             ((adc_type *) ADC1_BASE)
#define ADCCOM_LIB                           ((adccom_type *) ADCCOM_BASE)
