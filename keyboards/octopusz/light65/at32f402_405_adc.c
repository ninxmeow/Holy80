...
void adc_reset(adc_type *adc_x)
{
  if(adc_x == ADC1_LIB)
  {
    crm_periph_reset(CRM_ADC_PERIPH_RESET, ADC_CONFIRM_TRUE);
    crm_periph_reset(CRM_ADC_PERIPH_RESET, ADC_CONFIRM_FALSE);
  }
}
...
/**
  ...
  *         this parameter can be: ADC_CONFIRM_TRUE or ADC_CONFIRM_FALSE.
  *         note:after adc ready,user set adcen bit will cause ordinary conversion
  * @retval none
  */
void adc_enable(adc_type *adc_x, adc_confirm_state new_state)
{
...
{
  adc_base_struct->sequence_mode = ADC_CONFIRM_FALSE;
  adc_base_struct->repeat_mode = ADC_CONFIRM_FALSE;
...
{
  ADCCOM_LIB->cctrl_bit.adcdiv = div_value;
}
...
/**
  ...
  * @retval none
  */
void adc_dma_mode_enable(adc_type *adc_x, adc_confirm_state new_state)
{
...
/**
  ...
  * @retval none
  */
void adc_interrupt_enable(adc_type *adc_x, uint32_t adc_int, adc_confirm_state new_state)
{
  if(new_state == ADC_CONFIRM_TRUE)
  {
    adc_x->ctrl1 |= adc_int;
  }
  else if(new_state == ADC_CONFIRM_FALSE)
  {
    adc_x->ctrl1 &= ~adc_int;
  }
}
...
{
  adc_x->ctrl2_bit.adcalinit = ADC_CONFIRM_TRUE;
}
...
{
  adc_x->ctrl2_bit.adcal = ADC_CONFIRM_TRUE;
}
...
{
  adc_x->ctrl1_bit.ocvmen = ADC_CONFIRM_FALSE;
  adc_x->ctrl1_bit.pcvmen = ADC_CONFIRM_FALSE;
  adc_x->ctrl1_bit.vmsgen = ADC_CONFIRM_FALSE;
...
/**
  ...
  * @retval none
  */
void adc_ordinary_conversion_trigger_set(adc_type *adc_x, adc_ordinary_trig_select_type adc_ordinary_trig, adc_confirm_state new_state)
{
...
/**
  ...
  * @retval none
  */
void adc_preempt_conversion_trigger_set(adc_type *adc_x, adc_preempt_trig_select_type adc_preempt_trig, adc_confirm_state new_state)
{
...
/**
  ...
  * @retval none
  */
void adc_ordinary_part_mode_enable(adc_type *adc_x, adc_confirm_state new_state)
{
...
/**
  ...
  * @retval none
  */
void adc_preempt_part_mode_enable(adc_type *adc_x, adc_confirm_state new_state)
{
...
/**
  ...
  * @retval none
  */
void adc_preempt_auto_mode_enable(adc_type *adc_x, adc_confirm_state new_state)
{
...
/**
  ...
  * @retval none
  */
void adc_tempersensor_vintrv_enable(adc_confirm_state new_state)
{
  ADC1_LIB->ctrl2_bit.itsrven = new_state;
}
...
/**
  ...
  * @retval none
  */
void adc_ordinary_software_trigger_enable(adc_type *adc_x, adc_confirm_state new_state)
{
...
/**
  ...
  * @retval none
  */
void adc_preempt_software_trigger_enable(adc_type *adc_x, adc_confirm_state new_state)
{
...
/**
  ...
  * @retval none
  */
void adc_ordinary_oversample_enable(adc_type *adc_x, adc_confirm_state new_state)
{
...
/**
  ...
  * @retval none
  */
void adc_preempt_oversample_enable(adc_type *adc_x, adc_confirm_state new_state)
{
...
/**
  ...
  * @retval none
  */
void adc_ordinary_oversample_trig_enable(adc_type *adc_x, adc_confirm_state new_state)
{
