...
typedef enum {MISC_CONFIRM_FALSE = 0, MISC_CONFIRM_TRUE = !MISC_CONFIRM_FALSE} misc_confirm_state;
...
void nvic_lowpower_mode_config(nvic_lowpower_mode_type lp_mode, misc_confirm_state new_state);
