...
#include "at32f402_5xx.h"
 ...
 typedef enum {DMA_CONFIRM_FALSE = 0, DMA_CONFIRM_TRUE = !DMA_CONFIRM_FALSE} dma_confirm_state;
...
typedef struct
{
  ...
  dma_confirm_state                          peripheral_inc_enable;   /*!< periphera address increment after one transmit */
  dma_confirm_state                          memory_inc_enable;       /*!< memory address increment after one transmit */
  ...
  dma_confirm_state                          loop_mode_enable;        /*!< when loop mode enable, buffer size will reload if count to 0*/
...
typedef struct
{
  ...
  dma_confirm_state                          sync_event_enable;   /*!< dma dmamux event generation disabled */
  dma_confirm_state                          sync_enable;         /*!< dma dmamux synchronization enable */
...
typedef struct
{
  ...
  dma_confirm_state                          gen_enable;         /*!< dma dmamux generator enable */
...
#define DMA1_LIB                             ((dma_type *) DMA1_BASE)
#define DMA1_CHANNEL1_LIB                    ((dma_channel_type *) DMA1_CHANNEL1_BASE)
#define DMA1_CHANNEL2_LIB                    ((dma_channel_type *) DMA1_CHANNEL2_BASE)
#define DMA1_CHANNEL3_LIB                    ((dma_channel_type *) DMA1_CHANNEL3_BASE)
#define DMA1_CHANNEL4_LIB                    ((dma_channel_type *) DMA1_CHANNEL4_BASE)
#define DMA1_CHANNEL5_LIB                    ((dma_channel_type *) DMA1_CHANNEL5_BASE)
#define DMA1_CHANNEL6_LIB                    ((dma_channel_type *) DMA1_CHANNEL6_BASE)
#define DMA1_CHANNEL7_LIB                    ((dma_channel_type *) DMA1_CHANNEL7_BASE)

#define DMA1MUX_CHANNEL1_LIB                 ((dmamux_channel_type *) DMA1MUX_CHANNEL1_BASE)
#define DMA1MUX_CHANNEL2_LIB                 ((dmamux_channel_type *) DMA1MUX_CHANNEL2_BASE)
#define DMA1MUX_CHANNEL3_LIB                 ((dmamux_channel_type *) DMA1MUX_CHANNEL3_BASE)
#define DMA1MUX_CHANNEL4_LIB                 ((dmamux_channel_type *) DMA1MUX_CHANNEL4_BASE)
#define DMA1MUX_CHANNEL5_LIB                 ((dmamux_channel_type *) DMA1MUX_CHANNEL5_BASE)
#define DMA1MUX_CHANNEL6_LIB                 ((dmamux_channel_type *) DMA1MUX_CHANNEL6_BASE)
#define DMA1MUX_CHANNEL7_LIB                 ((dmamux_channel_type *) DMA1MUX_CHANNEL7_BASE)

#define DMA1MUX_GENERATOR1_LIB               ((dmamux_generator_type *) DMA1MUX_GENERATOR1_BASE)
#define DMA1MUX_GENERATOR2_LIB               ((dmamux_generator_type *) DMA1MUX_GENERATOR2_BASE)
#define DMA1MUX_GENERATOR3_LIB               ((dmamux_generator_type *) DMA1MUX_GENERATOR3_BASE)
#define DMA1MUX_GENERATOR4_LIB               ((dmamux_generator_type *) DMA1MUX_GENERATOR4_BASE)

#define DMA2_LIB                             ((dma_type *) DMA2_BASE)
#define DMA2_CHANNEL1_LIB                    ((dma_channel_type *) DMA2_CHANNEL1_BASE)
#define DMA2_CHANNEL2_LIB                    ((dma_channel_type *) DMA2_CHANNEL2_BASE)
#define DMA2_CHANNEL3_LIB                    ((dma_channel_type *) DMA2_CHANNEL3_BASE)
#define DMA2_CHANNEL4_LIB                    ((dma_channel_type *) DMA2_CHANNEL4_BASE)
#define DMA2_CHANNEL5_LIB                    ((dma_channel_type *) DMA2_CHANNEL5_BASE)
#define DMA2_CHANNEL6_LIB                    ((dma_channel_type *) DMA2_CHANNEL6_BASE)
#define DMA2_CHANNEL7_LIB                    ((dma_channel_type *) DMA2_CHANNEL7_BASE)

#define DMA2MUX_CHANNEL1_LIB                 ((dmamux_channel_type *) DMA2MUX_CHANNEL1_BASE)
#define DMA2MUX_CHANNEL2_LIB                 ((dmamux_channel_type *) DMA2MUX_CHANNEL2_BASE)
#define DMA2MUX_CHANNEL3_LIB                 ((dmamux_channel_type *) DMA2MUX_CHANNEL3_BASE)
#define DMA2MUX_CHANNEL4_LIB                 ((dmamux_channel_type *) DMA2MUX_CHANNEL4_BASE)
#define DMA2MUX_CHANNEL5_LIB                 ((dmamux_channel_type *) DMA2MUX_CHANNEL5_BASE)
#define DMA2MUX_CHANNEL6_LIB                 ((dmamux_channel_type *) DMA2MUX_CHANNEL6_BASE)
#define DMA2MUX_CHANNEL7_LIB                 ((dmamux_channel_type *) DMA2MUX_CHANNEL7_BASE)

#define DMA2MUX_GENERATOR1_LIB               ((dmamux_generator_type *) DMA2MUX_GENERATOR1_BASE)
#define DMA2MUX_GENERATOR2_LIB               ((dmamux_generator_type *) DMA2MUX_GENERATOR2_BASE)
#define DMA2MUX_GENERATOR3_LIB               ((dmamux_generator_type *) DMA2MUX_GENERATOR3_BASE)
#define DMA2MUX_GENERATOR4_LIB               ((dmamux_generator_type *) DMA2MUX_GENERATOR4_BASE)
...
void dma_interrupt_enable(dma_channel_type *dmax_channely, uint32_t dma_int, dma_confirm_state new_state);
void dma_channel_enable(dma_channel_type *dmax_channely, dma_confirm_state new_state);
...
void dmamux_enable(dma_type *dma_x, dma_confirm_state new_state);
...
void dmamux_sync_interrupt_enable(dmamux_channel_type *dmamux_channelx, dma_confirm_state new_state);
void dmamux_generator_interrupt_enable(dmamux_generator_type *dmamux_gen_x, dma_confirm_state new_state);
