...
typedef enum {GPIO_CONFIRM_FALSE = 0, GPIO_CONFIRM_TRUE = !GPIO_CONFIRM_FALSE} gpio_confirm_state;
...
#define GPIOA_LIB                            ((gpio_type *) GPIOA_BASE)
#define GPIOB_LIB                            ((gpio_type *) GPIOB_BASE)
#define GPIOC_LIB                            ((gpio_type *) GPIOC_BASE)
#define GPIOD_LIB                            ((gpio_type *) GPIOD_BASE)
#define GPIOF_LIB                            ((gpio_type *) GPIOF_BASE)
...
void gpio_bits_write(gpio_type *gpio_x, uint16_t pins, gpio_confirm_state bit_state);
void gpio_port_wirte(gpio_type *gpio_x, uint16_t port_value);
void gpio_pin_wp_config(gpio_type *gpio_x, uint16_t pins);
void gpio_pins_huge_driven_config(gpio_type *gpio_x, uint16_t pins, gpio_confirm_state new_state);
