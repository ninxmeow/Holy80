...
/**
  ...
  *         USART1_LIB, USART2_LIB, USART3_LIB, USART4_LIB, USART5_LIB, USART6_LIB, UART7_LIB,or UART8_LIB.
  * @retval none
  */
void usart_reset(usart_type* usart_x)
{
  if(usart_x == UART_CONFIRM_FALSE)
  {
    crm_periph_reset(CRM_USART1_PERIPH_RESET, UART_CONFIRM_TRUE);
    crm_periph_reset(CRM_USART1_PERIPH_RESET, UART_CONFIRM_FALSE);
  }
  else if(usart_x == USART2_LIB)
  {
    crm_periph_reset(CRM_USART2_PERIPH_RESET, UART_CONFIRM_TRUE);
    crm_periph_reset(CRM_USART2_PERIPH_RESET, UART_CONFIRM_FALSE);
  }
  else if(usart_x == USART3_LIB)
  {
    crm_periph_reset(CRM_USART3_PERIPH_RESET, UART_CONFIRM_TRUE);
    crm_periph_reset(CRM_USART3_PERIPH_RESET, UART_CONFIRM_FALSE);
  }
  else if(usart_x == USART4_LIB)
  {
    crm_periph_reset(CRM_USART4_PERIPH_RESET, UART_CONFIRM_TRUE);
    crm_periph_reset(CRM_USART4_PERIPH_RESET, UART_CONFIRM_FALSE);
  }
  else if(usart_x == USART5_LIB)
  {
    crm_periph_reset(CRM_USART5_PERIPH_RESET, UART_CONFIRM_TRUE);
    crm_periph_reset(CRM_USART5_PERIPH_RESET, UART_CONFIRM_FALSE);
  }
  else if(usart_x == USART6_LIB)
  {
    crm_periph_reset(CRM_USART6_PERIPH_RESET, UART_CONFIRM_TRUE);
    crm_periph_reset(CRM_USART6_PERIPH_RESET, UART_CONFIRM_FALSE);
  }
  else if(usart_x == UART7_LIB)
  {
    crm_periph_reset(CRM_UART7_PERIPH_RESET, UART_CONFIRM_TRUE);
    crm_periph_reset(CRM_UART7_PERIPH_RESET, UART_CONFIRM_FALSE);
  }
  else if(usart_x == UART8_LIB)
  {
    crm_periph_reset(CRM_UART8_PERIPH_RESET, UART_CONFIRM_TRUE);
    crm_periph_reset(CRM_UART8_PERIPH_RESET, UART_CONFIRM_FALSE);
  }
}
...
/**
  ...
  * @param  usart_x: select the usart or the uart peripheral.
  *         this parameter can be one of the following values:
  *         UART_CONFIRM_FALSE, USART2_LIB, USART3_LIB, USART4_LIB ,USART5_LIB, USART6_LIB, UART7_LIB or UART8_LIB.
...
void usart_init(usart_type* usart_x, uint32_t baud_rate, usart_data_bit_num_type data_bit, usart_stop_bit_num_type stop_bit)
{
  ...
  if((usart_x == USART1_LIB) || (usart_x == USART6_LIB) ||  (usart_x == UART7_LIB) || (usart_x == UART8_LIB))
  {
...
void usart_parity_selection_config(usart_type* usart_x, usart_parity_selection_type parity)
{
  ...
  {
    usart_x->ctrl1_bit.psel = UART_CONFIRM_FALSE;
    usart_x->ctrl1_bit.pen = UART_CONFIRM_FALSE;
  }
  else if(parity == USART_PARITY_EVEN)
  {
    usart_x->ctrl1_bit.psel = UART_CONFIRM_FALSE;
    usart_x->ctrl1_bit.pen = UART_CONFIRM_TRUE;
  }
  else if(parity == USART_PARITY_ODD)
  {
    usart_x->ctrl1_bit.psel = UART_CONFIRM_TRUE;
    usart_x->ctrl1_bit.pen = UART_CONFIRM_TRUE;
  }
}
...
/**
  ...
  *         this parameter can be: UART_CONFIRM_TRUE or UART_CONFIRM_FALSE.
  * @retval none
  */
void usart_enable(usart_type* usart_x, uart_confirm_state new_state)
{
...
/**
  ...
  *         this parameter can be one of the following values:
  *         USART1_LIB, USART2_LIB, USART3_LIB, USART4_LIB ,USART5_LIB, USART6_LIB, UART7_LIB or UART8_LIB.
  * @param  new_state: UART_CONFIRM_TRUE or UART_CONFIRM_FALSE.
  * @retval none
  */
void usart_transmitter_enable(usart_type* usart_x, uart_confirm_state new_state)
{
...
/**
  ...
  * @retval none
  */
void usart_receiver_enable(usart_type* usart_x, uart_confirm_state new_state)
{
...
/**
  ...
  * @param  usart_x: select the usart or the uart peripheral.
  *         this parameter can be one of the following values:
  *         USART1_LIB, USART2_LIB, USART3_LIB, USART4_LIB ,USART5_LIB or USART6_LIB.
...
/**
  ...
  * @retval none
  */
void usart_clock_enable(usart_type* usart_x, uart_confirm_state new_state)
{
...
/**
  ...
  * @retval none
  */
void usart_interrupt_enable(usart_type* usart_x, uint32_t usart_int, uart_confirm_state new_state)
{
  if(new_state == UART_CONFIRM_TRUE)
...
/**
  ...
  * @retval none
  */
void usart_dma_transmitter_enable(usart_type* usart_x, uart_confirm_state new_state)
{
...
/**
  ...
  * @param  usart_x: select the usart or the uart peripheral.
  *         this parameter can be one of the following values:
  *         USART1_LIB, USART2_LIB, USART3_LIB, UART4, UART5, USART6_LIB, UART7_LIB or UART8_LIB.
  * @param  new_state: new state of the dma request sources.
  *         this parameter can be: UART_CONFIRM_TRUE or UART_CONFIRM_FALSE.
  * @retval none
  */
void usart_dma_receiver_enable(usart_type* usart_x, uart_confirm_state new_state)
{
...
/**
  ...
  * @retval none
  */
void usart_receiver_mute_enable(usart_type* usart_x, uart_confirm_state new_state)
{
...
/**
  ...
  * @retval none
  */
void usart_lin_mode_enable(usart_type* usart_x, uart_confirm_state new_state)
{
...
{
  usart_x->ctrl1_bit.sbf = UART_CONFIRM_TRUE;
}

/**
  * @brief  config the specified usart smartcard guard time.
  * @note   The guard time bits are not available for UART4, UART5, UART7_LIB or UART8_LIB.
  * @param  usart_x: select the usart or the uart peripheral.
  *         this parameter can be one of the following values:
  *         USART1_LIB, USART2_LIB, USART3_LIB or USART6_LIB.
...
/**
  ...
  * @note   the division are not available for UART4, UART5, UART7_LIB or UART8_LIB.
  * @param  usart_x: select the usart or the uart peripheral.
  *         this parameter can be one of the following values:
  *         USART1_LIB, USART2_LIB, USART3_LIB or USART6_LIB.
...
/**
  ...
  * @note   the smart card mode are not available for UART4, UART5, UART7_LIB or UART8_LIB.
  * @param  usart_x: select the usart or the uart peripheral.
  *         this parameter can be one of the following values:
  *         USART1_LIB, USART2_LIB, USART3_LIB or USART6_LIB.
  ...
  * @retval none
  */
void usart_smartcard_mode_enable(usart_type* usart_x, uart_confirm_state new_state)
{
...
/**
  ...
  * @note   the smart card nack are not available for UART4, UART5, UART7_LIB or UART8_LIB.
  * @param  usart_x: select the usart or the uart peripheral.
  *         this parameter can be one of the following values:
  *         USART1_LIB, USART2_LIB, USART3_LIB or USART6_LIB.
  ...
  * @retval none
  */
void usart_smartcard_nack_set(usart_type* usart_x, uart_confirm_state new_state)
{
...
/**
  ...
  * @retval none
  */
void usart_single_line_halfduplex_select(usart_type* usart_x, uart_confirm_state new_state)
{
...
/**
  ...
  * @retval none
  */
void usart_irda_mode_enable(usart_type* usart_x, uart_confirm_state new_state)
{
...
/**
  ...
  * @retval none
  */
void usart_irda_low_power_enable(usart_type* usart_x, uart_confirm_state new_state)
{
...
/**
  ...
  * @param  usart_x: select the usart or the uart peripheral.
  *         this parameter can be one of the following values:
  *         USART1_LIB, USART2_LIB, USART3_LIB
...
void usart_hardware_flow_control_set(usart_type* usart_x,usart_hardware_flow_control_type flow_state)
{
  ...
  {
    usart_x->ctrl3_bit.rtsen = UART_CONFIRM_FALSE;
    usart_x->ctrl3_bit.ctsen = UART_CONFIRM_FALSE;
  }
  else if(flow_state == USART_HARDWARE_FLOW_RTS)
  {
    usart_x->ctrl3_bit.rtsen = UART_CONFIRM_TRUE;
    usart_x->ctrl3_bit.ctsen = UART_CONFIRM_FALSE;
  }
  else if(flow_state == USART_HARDWARE_FLOW_CTS)
  {
    usart_x->ctrl3_bit.rtsen = UART_CONFIRM_FALSE;
    usart_x->ctrl3_bit.ctsen = UART_CONFIRM_TRUE;
  }
...
/**
  ...
  *         this parameter can be one of the following values:
  *         - USART_CMDF_FLAG:   character match detection flag  (not available for USART4_LIB,USART5_LIB,USART6_LIB,USART7_LIB and USART8_LIB)
  *         - USART_RTODF_FLAG:  receiver time out detection flag
  *         - USART_CTSCF_FLAG: cts change flag (not available for USART5_LIB,USART6_LIB,UART7_LIB and UART8_LIB)
...
/**
  ...
  *         - USART_CMDF_FLAG:   character match detection flag
  *         - USART_RTODF_FLAG:  receiver time out detection flag
  *         - USART_CTSCF_FLAG: (not available for USART5_LIB,USART6_LIB,UART7_LIB and UART8_LIB).
  *         - USART_BFF_FLAG:
  *         - USART_TDC_FLAG:
  *         - USART_RDBF_FLAG:
  *         - USART_PERR_FLAG:
...
/**
  ...
  * @retval none
  */
void usart_transmit_receive_pin_swap(usart_type* usart_x, uart_confirm_state new_state)
{
...
/**
  ...
  * @retval none
  */
void usart_de_polarity_reverse(usart_type* usart_x, uart_confirm_state new_state)
{
...
/**
  ...
  * @retval none
  */
void usart_rs485_mode_enable(usart_type* usart_x, uart_confirm_state new_state)
{
...
/**
  ...
  * @param  usart_x: select the usart or the uart peripheral.
  *         this parameter can be one of the following values:
  *         USART1_LIB, USART2_LIB, USART3_LIB, USART4_LIB, USART5_LIB, USART6_LIB, UART7_LIB and UART8_LIB.
  * @param  new_state: new state of the irda mode.
  *         this parameter can be: UART_CONFIRM_TRUE or UART_CONFIRM_FALSE.
  * @retval none
  */
void usart_msb_transmit_first_enable(usart_type* usart_x, uart_confirm_state new_state)
{
...
/**
  ...
  * @retval none
  */
void usart_dt_polarity_reverse(usart_type* usart_x, uart_confirm_state new_state)
{
...
/**
  ...
  * @retval none
  */
void usart_transmit_pin_polarity_reverse(usart_type* usart_x, uart_confirm_state new_state)
{
...
/**
  ...
  * @retval none
  */
void usart_receive_pin_polarity_reverse(usart_type* usart_x, uart_confirm_state new_state)
{
...
/**
  ...
  * @retval none
  */
void usart_receiver_timeout_detection_enable(usart_type* usart_x, uart_confirm_state new_state)
{
